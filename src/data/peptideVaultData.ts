...
export const peptides: Peptide[] = [
  ...
  },
  {
    ...
    classe: "Dual Agonista GLP-1/Glucagon Endógeno",
    status: "Pesquisa Avançada",
    badge: "🔥 ENDÓGENO",
    badgeColor: "#f59e0b",
    color: "#f59e0b",
    halfLife: "~12min",
    discovery: "Peptídeo endógeno de 37 aminoácidos secretado pelas células L intestinais após ingestão de nutrientes. Derivado do proglucagon — o mesmo gene que gera GLP-1 e glucagon. É o 'dual agonista natural' que a indústria farmacêutica tentou replicar com tirzepatida.",
    mechanism: "Ativa simultaneamente GLP-1R e GcgR: GLP-1R → supressão de apetite central, retardo do esvaziamento gástrico, tolerância à glicose. GcgR → aumento do gasto energético, lipólise hepática, termogênese. A combinação promove perda de peso superior ao agonismo isolado de GLP-1.",
    pharmacokinetics: "t½: ~12min (degradação rápida por DPP-4 e NEP 24.11) | Secreção: pós-prandial proporcional à carga calórica | Via endógena: liberação intestinal | Via exógena: SC/IV (pesquisa)",
    clinicalData: "Administração subcutânea por 4 semanas reduz peso corporal em ~2.3kg vs placebo (Wynne et al., Diabetes 2005). Redução da ingestão alimentar em ~17.4% em dose única (Cohen et al., JCEM 2003). Protocolo GOP (GLP-1 + OXM + PYY) reduziu ingestão em 42.7% — Diabetes Care 2019.",
    dosage: "Pesquisa: 3-6nmol/kg IV ou SC, 3x/dia pré-prandial. Análogos estabilizados em desenvolvimento (meia-vida estendida). Dose endógena otimizada com refeições ricas em fibra e proteína.",
    synergies: "OXM + PYY3-36: efeito anorexígeno aditivo (redução de 42.7% na ingestão). OXM + GLP-1 nativo: sinergia via receptores compartilhados. OXM + exercício pós-prandial: potencializa gasto energético via GcgR.",
    dietImpact: "O dual agonismo natural sugere que refeições que maximizam secreção de OXM (proteína + fibra + gorduras saudáveis) podem replicar parte do efeito farmacológico. Timing de nutrientes é crítico: janela de secreção curta (~12min de meia-vida).",
    recentStudies: [
      "🔬 2025 — Physiological Reviews — Gasbjerg et al.: papel fisiológico completo dos peptídeos derivados do proglucagon",
      "🔬 2019 — Diabetes Care — Protocolo GOP: OXM + GLP-1 + PYY reduziu ingestão em 42.7%",
      "🔬 2024 — Nature Signal Transduction — Mecanismos do receptor GLP-1R e avanços terapêuticos",
    ],
  },
  {
    id: "pyy336",
    ...
    status: "Pesquisa Clínica",
    badge: "🧠 SACIEDADE",
    badgeColor: "#8b5cf6",
    color: "#8b5cf6",
    halfLife: "~25min",
    discovery: "PYY3-36 é a forma bioativa do Peptídeo YY, co-secretado com OXM e GLP-1 pelas células L intestinais após cada refeição. Atua via receptor NPY2R no hipotálamo para sinalizar saciedade. É um dos 'freios naturais' mais potentes do apetite.",
    mechanism: "Liga-se preferencialmente ao receptor NPY2R no núcleo arqueado do hipotálamo → inibe neurônios NPY/AgRP (orexígenos) e ativa POMC/CART (anorexígenos). Retarda esvaziamento gástrico. Reduz motilidade intestinal. Efeito amplificado quando combinado com OXM (sinergia aditiva documentada).",
    pharmacokinetics: "t½: ~25min (mais estável que OXM e GLP-1 nativo) | Secreção: 15-30min pós-refeição, pico em 1-2h | Proporcional ao conteúdo calórico e lipídico da refeição | Via: endógena intestinal",
    clinicalData: "Administração IV reduz ingestão calórica em ~33% em voluntários saudáveis (Batterham et al., Nature 2002). Combinação OXM+PYY: redução de 42.7% na ingestão (NCBI). Níveis cronicamente baixos em obesos — possível alvo terapêutico para restauração da saciedade.",
    dosage: "Pesquisa: 0.8pmol/kg/min IV (infusão). Análogos nasais em desenvolvimento. Otimização endógena: refeições com >25g gordura + >30g proteína maximizam secreção de PYY.",
    synergies: "PYY + OXM: efeito anorexígeno aditivo documentado. PYY + GLP-1: eixo completo de saciedade das células L. PYY + fibra solúvel (inulina/FOS): prebióticos aumentam produção endógena de PYY.",
    dietImpact: "Estratégia nutricional para maximizar PYY endógeno: proteína no início da refeição, gorduras saudáveis, fibra fermentável. Dietas muito low-fat podem reduzir secreção de PYY. Jejum intermitente pode aumentar sensibilidade ao PYY na re-alimentação.",
    recentStudies: [
      "🔬 2019 — Diabetes Care — Protocolo GOP: combinação GLP-1+OXM+PYY reduziu ingestão em 42.7%",
      "🔬 2025 — Physiological Reviews — Papel dos peptídeos proglucagon na regulação energética",
      "🔬 2024 — Obesity Reviews — PYY como biomarcador de saciedade em intervenções dietéticas",
    ],
  },
  {
    id: "glp2",
    ...
    status: "FDA Aprovado (Teduglutida)",
    badge: "✅ APROVADO",
    badgeColor: "#a3e635",
    color: "#a3e635",
    halfLife: "~7min (nativo) / ~3h (teduglutida)",
    discovery: "GLP-2 é co-secretado com GLP-1 pelas células L intestinais, derivado do mesmo precursor proglucagon. Processado pela pró-hormônio convertase 1/3 no intestino. Seu análogo teduglutida (Gattex®) é FDA-aprovado para síndrome do intestino curto.",
    mechanism: "Atua via receptor GLP-2R em neurônios entéricos e subepiteliais → estimula proliferação de células da cripta intestinal, aumenta altura das vilosidades, melhora absorção de nutrientes. Reduz permeabilidade intestinal (restaura tight junctions). Aumenta fluxo sanguíneo mesentérico. Inibe apoptose de enterócitos.",
    pharmacokinetics: "t½ nativo: ~7min (degradação por DPP-4) | Teduglutida (análogo): t½ ~3h | Via: SC diária | Secreção endógena: pós-prandial, proporcional a carboidratos e lipídios",
    clinicalData: "Teduglutida: redução de 20-100% na necessidade de nutrição parenteral em síndrome do intestino curto. Aumento de altura de vilosidades em 50-100%. Altamente relevante para protocolos de modulação do microbioma e permeabilidade intestinal.",
    dosage: "Teduglutida (Gattex®): 0.05mg/kg SC diária. Otimização endógena: glutamina 10-20g/dia + fibra fermentável + butirato estimulam secreção de GLP-2.",
    synergies: "GLP-2 + BPC-157: sinergismo na restauração da barreira intestinal. GLP-2 + probióticos (Akkermansia): modulação do eixo microbioma-intestino. GLP-2 + glutamina: substrato + fator trófico = reparo intestinal acelerado.",
    dietImpact: "Fundamental para atletas com permeabilidade intestinal comprometida (leaky gut pós-treino). Absorção de nutrientes pode aumentar 30-50% com integridade intestinal restaurada. Estratégia: fibra fermentável + amido resistente para maximizar GLP-2 endógeno.",
    recentStudies: [
      "🔬 2025 — Physiological Reviews — Gasbjerg et al.: GLP-2 no eixo intestino-cérebro",
      "🔬 2024 — Gut — Restauração de tight junctions via GLP-2R e conexão com microbioma",
      "🔬 2025 — Frontiers Mol Biosciences — Agonistas orais de GLP-1/GLP-2 em desenvolvimento",
    ],
  },
  {
    id: "glicentin",
    ...
    status: "Pesquisa Emergente",
    badge: "🔍 EMERGENTE",
    badgeColor: "#06b6d4",
    color: "#06b6d4",
    halfLife: "~6-8min",
    discovery: "Peptídeo de 69 aminoácidos derivado do proglucagon, co-secretado com GLP-1, GLP-2 e OXM pelas células L intestinais. Contém a sequência completa da oxintomodulina + GRPP (glicentin-related pancreatic polypeptide). Papel fisiológico ainda sob investigação ativa.",
    mechanism: "Papel emergente na motilidade gastrointestinal: modula trânsito intestinal e secreção gástrica. Possível efeito protetor sobre células beta pancreáticas. Não se liga com alta afinidade ao GLP-1R ou GcgR isoladamente — sugere receptor próprio ainda não identificado ou ação via metabolismo a OXM.",
    pharmacokinetics: "t½: ~6-8min | Secreção: pós-prandial pelas células L | Metabolizada parcialmente a OXM no intestino | Eliminação: proteólise e renal",
    clinicalData: "Marcador sérico emergente para função de células L intestinais. Correlação com motilidade gastrointestinal em estudos observacionais. Dados preliminares sugerem papel na adaptação intestinal pós-cirurgia bariátrica.",
    dosage: "Sem protocolo exógeno estabelecido. Pesquisa apenas. Otimização endógena: mesmas estratégias que maximizam GLP-1 e OXM (refeições ricas em proteína, fibra e gorduras saudáveis).",
    synergies: "Co-secretada com GLP-1 + GLP-2 + OXM + PYY — faz parte do 'cocktail de saciedade' das células L. Estudo do eixo completo proglucagon é necessário para entender sinergias.",
    dietImpact: "Como marcador de função das células L, seus níveis podem indicar saúde intestinal e eficiência da sinalização de saciedade. Dietas que estimulam células L (fibra, AGCC, proteína) provavelmente aumentam glicentin proporcionalmente.",
    recentStudies: [
      "🔬 2025 — Physiological Reviews — Gasbjerg et al.: papel completo dos peptídeos derivados do proglucagon incluindo glicentin",
      "🔬 2025 — Frontiers Endocrinology — Lee et al.: glucagon e peptídeos relacionados em doença metabólica",
      "🔬 2024 — Company Hero — Processamento tecido-específico do proglucagon via PC1/3 e PC2",
    ],
  },
];

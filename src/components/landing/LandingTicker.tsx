const ITEMS_A = [
  "LOW CARB", "CETOGÊNICA", "JEJUM 16/8", "HIGH CARB", "MEN'S PHYSIQUE", "VEGANO PLANT-BASED",
  "CUTTING · BULK · RECOMP", "PEAK WEEK", "FLAT · FULL · SPILLED", "STAGE PREP",
];

const ITEMS_B = [
  "GEB · GET · VET", "JANELA ANABÓLICA", "PROTOCOLO FARMACOLÓGICO", "CRONOBIOLOGIA", "SUA FOME NUNCA FOI DE COMIDA",
  "TCC NUTRICIONAL", "NUTRIENT TIMING", "MUSCLE STATE", "SONO & RECUPERAÇÃO", "PERIODIZAÇÃO DE FASES",
];

const ITEMS_A = [
  ...
  "WOMEN'S PHYSIQUE", "MMA · CROSSFIT", "RUNNING · NATAÇÃO", "PEAK WEEK",
  "LONGEVIDADE", "SAÚDE & BEM-ESTAR", "CUTTING · BULK · RECOMP", "STAGE PREP",
];

const ITEMS_B = [
  "MUSCLE STATE · FLAT/FULL/SPILLED", "PROTOCOLO FARMACOLÓGICO", "NUTRIENT TIMING", "CRONOBIOLOGIA",
  "SUA FOME NUNCA FOI DE COMIDA", "TCC NUTRICIONAL", "PERIODIZAÇÃO DE FASES", "MCE · METODOLOGIA",
  "MARCADORES BIOLÓGICOS", "ANTI-AGING", "JANELA ANABÓLICA", "VO2 MAX · PERFORMANCE",
];

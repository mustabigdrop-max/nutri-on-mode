...
const modules: Mod[] = [
  ...
  { num: "04", icon: "⚗", title: "DR. VERTEX", subtitle: "Inteligência farmacológica", color: "#7B2FBE", text: "85+ compostos catalogados. Auditoria de protocolo em tempo real. Análise de sinergia entre compostos. Alertas de interação farmacológica. Periodização farmacológica por fase. Ciência sem censura. Prática sem medo." },

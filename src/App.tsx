...
// Fallback leve enquanto o chunk da rota (lazy) carrega — cada página agora
// vira seu próprio bundle, então a tela inicial não baixa/parseia o app inteiro.
const RouteFallback = () => (
  <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh" }}>
    <Loader2 className="animate-spin" style={{ color: "#4ade80" }} size={28} />
  </div>
);

...
const ApexMapaPage = lazy(() => import("./pages/ApexMapaPage"));
...
const SteroidVaultPage = lazy(() => import("./pages/SteroidVaultPage"));
      ...
      <AuthProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/steroid-vault" element={<ProtectedRoute><SteroidVaultPage /></ProtectedRoute>} />
            {/* Training & Science */}

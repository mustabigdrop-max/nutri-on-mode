...
const SCHEMAS: Record<Mode, string> = {
  ...
  video_breakdown: `{"exercicio":"Nome do exercício","padrao":"Squat|Push|Pull|Hinge|Carry|Rotation","musculos_primarios":["max 3"],"musculos_secundarios":["max 3"],"execucao":{"titulo":"Ponto-chave desta fase em 4-6 palavras","descricao":"2 frases técnicas: ângulos articulares, ativação e o que observar","cue":"Dica técnica mais importante em 1 frase curta","erro_comum":"Erro mais comum nesta fase em 1 frase"},"musculos_ativos":{"peitoral":0,"deltoide":0,"biceps":0,"triceps":0,"trapezio":0,"dorsais":0,"abdomen":0,"obliquos":0,"lombar":0,"gluteos":0,"quadriceps":0,"isquiotibiais":0,"panturrilha":0,"adutor":0},"mce":{"mentalidade":"como pensar durante a execução — 1 frase forte","comportamento":"o hábito que sustenta a qualidade — 1 frase","execucao_mce":"o dado/registro que importa — 1 frase"},"alerta_apex":"Por que este exercício exige avaliação postural prévia — 1 frase de urgência","frase_impacto":"Bordão curto e compartilhável sobre este exercício"}`,

...
const SCHEMAS: Record<Mode, string> = {
  ...
  nexus_carousel: `{"slide1_titulo":"pergunta provocativa ou afirmação forte sobre o composto, até 14 palavras, com **destaques** entre asteriscos duplos","slide1_classe":"classe farmacológica ou categoria, até 4 palavras","slide1_status":"APROVADO|PESQUISA|EXPERIMENTAL","slide2_oque":"o que é, explicação simples e correta, máximo 150 caracteres","slide2_traducao":"em linguagem leiga, o que faz, máximo 100 caracteres","slide3_mecanismo":"mecanismo de ação simplificado mas completo, máximo 200 caracteres","slide3_analogia":"analogia simples para leigo, máximo 80 caracteres","slide4_beneficios":["3 a 4 benefícios, cada um com dado real e nome do estudo com ano quando existir"],"slide5_riscos":["3 itens: efeitos colaterais documentados e limitações reais"],"slide5_nao_indicado":"para quem NÃO é indicado, máximo 100 caracteres","slide6_comparativo_com":"nome do composto comparado, ou string vazia se não houver comparação honesta possível","slide6_comparativo":[{"criterio":"Eficácia","composto1":"dado curto","composto2":"dado curto"},"3 linhas: eficácia, meia-vida/duração e via de uso; array vazio se não houver comparação"],"slide7_evidencia":"FORTE|MODERADA|PRELIMINAR","slide7_estudos":["2 a 4 estudos reais no formato Nome do estudo ou autor (ano)"],"slide7_regulatorio":"status FDA e ANVISA em até 20 palavras; se experimental, deixe explícito que não tem aprovação regulatória","slide8_pratica":["3 itens: para quem faz sentido considerar, o que perguntar ao médico, o que avaliar antes"],"slide9_resumo":{"oque":"resumo em 1 frase curta","funciona":"resumo em 1 frase curta","beneficio_principal":"resumo em 1 frase curta","risco_principal":"resumo em 1 frase curta"},"legenda":"legenda completa pro Instagram, máximo 800 caracteres, com referências científicas, emojis 🧬🔬📊, hashtags científicas e disclaimer no final"}`,

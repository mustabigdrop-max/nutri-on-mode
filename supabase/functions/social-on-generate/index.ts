...
const SCHEMAS: Record<Mode, string> = {
  ...
  video_content: `{"exercicio":"nome do exercício identificado no frame","padrao_movimento":"Push|Pull|Hinge|Squat|Carry|Rotation","musculos_primarios":["lista"],"musculos_secundarios":["lista"],"zonas_corporais_ativas":["somente itens desta lista fixa: upper_chest, lower_chest, front_delt, side_delt, rear_delt, biceps, triceps, forearms, upper_back, lats, lower_back, core, glutes, quads, hamstrings, calves"],"metricas":{"complexidade":0,"risco_sem_avaliacao":0,"impacto_assimetria":0,"necessidade_correcao":0},"analise_execucao":{"pontos_positivos":["2 a 3 pontos bons observados no frame"],"pontos_atencao":["2 a 3 pontos a corrigir ou observar"],"cue_principal":"a dica de execução mais importante em 1 frase","angulacoes_chave":["ângulos articulares importantes no exercício, ex: joelho 90°, quadril neutro"]},"conteudo":{"hook_reels":"frase de gancho pros primeiros 3s do Reels, impactante, máximo 12 palavras","roteiro_reels":"roteiro completo de Reels 30-60s no formato GANCHO (3s) → PROBLEMA (5s) → ANÁLISE (10s) → SOLUÇÃO (10s) → CTA (5s), linguagem direta e ritmo rápido, mencionando APEX e TrainingON naturalmente","caption_educativa":"legenda pro feed 150-200 palavras, educativa e técnica mas acessível, mostrando o processo avaliação visual → prescrição individualizada → acompanhamento comportamental, com CTA suave no final e quebras de linha","caption_profissional":"legenda B2B 150-200 palavras direcionada a personal trainers e nutricionistas, foco em como o sistema nutriON eleva o trabalho do profissional (APEX, STRATUM, MCE), convite pra conhecer a plataforma no final","carrossel_slides":["Slide 1: gancho visual","Slide 2: o problema","Slide 3: análise técnica","Slide 4: como o nutriON resolve","Slide 5: CTA"],"hashtags":["15 a 20 hashtags relevantes, sem acento"]},"apex_insight":"2-3 frases conectando a avaliação APEX com este exercício específico (assimetrias, desvios posturais que mudam a prescrição)","mce_insight":"2-3 frases conectando o MCE com a prática deste exercício (mentalidade na série, comportamento de registro, execução técnica)","frase_impacto":"1 frase poderosa sobre este exercício no contexto do nutriON, tipo assinatura de conteúdo"}`,
...
- Tom direto, científico e autoral. Keywords contém somente termos realmente presentes no slide.`
      ...
      body?.mode === "video_content"
        ? `Você é o ESTRATEGISTA do SOCIAL ON analisando o frame real de um exercício em execução. CONTEXTO DO ECOSSISTEMA: APEX Visual Intelligence (avaliação visual de postura, assimetrias e desvios articulares ANTES de prescrever), TrainingON/STRATUM (motor de periodização em 7 camadas: feeder sets, top sets com RIR, back-off sets, perfis de fibra muscular, DUP e deload), Método MCE (Mentalidade, Comportamento, Execução — "Transformação é sistema."), NutriPlan (nutrição comportamental integrada ao treino). REGRAS: identifique o exercício, o padrão de movimento e os músculos pelo que você REALMENTE vê no frame; analise posição articular, alinhamento e compensações visíveis; conecte naturalmente com APEX → TrainingON → MCE (primeiro avaliação, depois prescrição, sustentado por comportamento); tom TÉCNICO + ACESSÍVEL; NUNCA use "IA", "AI" ou "inteligência artificial" — use "análise", "sistema", "protocolo", "mapeamento"; o conteúdo funciona para profissionais E praticantes. CAMPOS ESPECIAIS: em "zonas_corporais_ativas" use SOMENTE chaves da lista fixa do schema, marcando as zonas realmente ativadas no exercício; em "metricas" preencha 4 scores de 0 a 100 realistas (complexidade do exercício, risco de executá-lo sem avaliação prévia, impacto de assimetrias na execução, necessidade de correção técnica); em "angulacoes_chave" liste os ângulos articulares relevantes visíveis ou exigidos (ex: joelho ~90°, quadril neutro); "frase_impacto" é uma assinatura curta e memorável sobre o exercício no contexto nutriON.`
        : "",

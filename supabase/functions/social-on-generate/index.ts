...
const SCHEMAS: Record<Mode, string> = {
  ...
  print_nutrion: `{"tipo_tela":"treino|plano_alimentar|nutrisync|diagnostico|muscular|nexus|outro","titulo_tela":"nome da tela como aparece no print, até 6 palavras","elementos_visiveis":[{"elemento":"nome do que aparece na tela","descricao":"o que é e por que importa, até 90 caracteres","posicao_y_percentual":0.3,"destaque":"o diferencial a apontar, até 70 caracteres","lado_anotacao":"esquerda|direita"},"3 a 4 itens que você REALMENTE vê no print, ordenados de cima pra baixo"],"gancho_slide1":"frase de impacto pra capa, máximo 60 caracteres","subtexto_slide1":"complemento, máximo 40 caracteres","slides_zoom":[{"titulo":"título do slide de zoom, até 6 palavras","area_recorte":"o que está nessa área do print","posicao_y_percentual":0.4,"explicacao":"o que essa parte faz e por que é diferencial, 25 a 40 palavras","comparativo":"o que apps comuns fazem vs o que essa tela faz, até 140 caracteres"},"2 a 4 itens"],"comparativo":{"outros_apps":["3 a 4 frases curtas do que apps comuns entregam"],"nutrion":["3 a 4 frases curtas do que esta tela entrega, só o que aparece no print"]},"stories":[{"tipo":"MOCKUP_PRINT","texto":"frase principal do frame, máximo 70 caracteres","subtexto":"complemento, máximo 45 caracteres"},{"tipo":"ZOOM_FEATURE","texto":"frase sobre a feature em destaque, máximo 70 caracteres","subtexto":"provocação curta, ex: Seu app faz isso?","posicao_y_percentual":0.4},{"tipo":"CTA","texto":"pergunta de fechamento, máximo 40 caracteres","cta":"chamada final curta"}],"reels":{"hook":"frase dos primeiros 3 segundos, até 12 palavras","cortes":[{"segundo":"0-3s","texto_tela":"TEXTO EM CAIXA ALTA, até 6 palavras","acao":"direção de gravação mostrando a tela"},"exatamente 5 cortes cobrindo 0-3s, 3-8s, 8-13s, 13-18s e 18-20s"]},"dados_extraidos":{"exercicios":["nomes de exercícios legíveis no print, ou lista vazia"],"macros":"macros legíveis no print, ou string vazia","calorias":"calorias legíveis no print, ou string vazia","treino_nome":"nome do treino legível no print, ou string vazia"},"legenda":"legenda pro Instagram focada no diferencial mostrado no print, máximo 600 caracteres, sem hashtags, sem markdown, tom de fundador mostrando o que construiu","self_comment":"pergunta que provoca, ex: Seu app faz isso?, máximo 80 caracteres","hashtags_top5":["5 hashtags relevantes pro tipo de tela"]}`,

...
const SCHEMAS: Record<Mode, string> = {
  ...
  meal_post_caption: `{"estilo":"o id do estilo pedido","legendas":[{"texto":"legenda completa em texto puro com quebras de linha \\n, entre 300 e 700 caracteres, SEM markdown, no tom do estilo pedido, usando SOMENTE os dados reais da refeição","hashtags":["4 a 8 hashtags relevantes"]},"1 a 3 opções realmente diferentes entre si"]}`,
  meal_story_plan: `{"tipos":[{"tipo":"FOTO ÚNICA|SEQUÊNCIA (2-4 stories)|SEQUÊNCIA EDUCATIVA (5+ stories)","estrategias":[{"nome":"nome curto da estratégia, até 5 palavras","slides":1,"desc":"o que essa estratégia faz e por que funciona, até 160 caracteres","layout":"instrução de montagem story por story, uma linha por story, usando os dados reais da refeição","cta":"interação sugerida (enquete, quiz, slider ou caixinha) com o texto pronto"},"2 a 3 estratégias por tipo"]},"exatamente 3 tipos na ordem acima"]}`,
  ...
  module_content: `{"titulo":"título curto do conteúdo gerado","carrossel":{"slides":[{"tipo":"capa|conteudo|dados|comparativo|dica|cta","tag":"TAG DO SLIDE","titulo":"25 a 50 caracteres","corpo":"OBRIGATÓRIO: 120 a 200 caracteres, 2 a 3 frases completas, nunca vazio","dados":[{"label":"rótulo curto","valor":"valor real"},"2 a 3 itens quando houver dado real da tela"],"destaque":"número ou palavra de impacto, ou string vazia"},"7 a 10 slides, o último sempre tipo cta"],"legenda":"legenda do Instagram, entre 400 e 600 caracteres, com abertura em gancho, desenvolvimento em 3 blocos e CTA, sem hashtags e sem markdown","self_comment":"pergunta pro primeiro comentário, máximo 80 caracteres","hashtags_top5":["5 hashtags"],"hashtags_15":["15 hashtags"]},"reels":{"hook":"frase dos 3 primeiros segundos","duracao":"30s","cortes":[{"segundo":"0-3s","texto_tela":"TEXTO EM CAIXA ALTA ATÉ 40 CARACTERES","fala":"o que o coach fala","acao":"o que fazer na câmera"},"exatamente 5 cortes"],"legenda_reels":"máximo 400 caracteres","musica":"estilo de áudio sugerido"},"stories":{"frames":[{"tipo":"HOOK|DADO|ERRO|COMPARATIVO|ENQUETE|QUIZ|CTA","texto":"texto principal","subtexto":"complemento","opcoes":["quando enquete ou quiz"],"fundo":"#0A0A0A ou #EF9F27"},"4 a 5 frames"]},"timing":{"stories":"agora","reels":"horário ideal","carrossel":"horário ideal, nunca no mesmo dia do reels"},"checklist":["3 a 5 ações com tempo estimado"],"disclaimer":"disclaimer quando exigido, senão string vazia"}`,
  carousel_engine: `{"slides":[{"slide_number":1,"type":"cover","eyebrow":"categoria curta","title":"gancho científico forte em até 9 palavras","accent_word":"palavra principal","subtitle":"promessa editorial sem exagero","svg_category":"muscular|nutricao|hormonal|comportamento","svg_element":"fibras|sarcomero|mtor|mitocondria|krebs|cadeia_eletrons|glicolise|receptor|eixo|feedback|radar_mce|habito|neuronio"},{"slide_number":2,"type":"content","variation":"A","header":"título","category_tag":"tag","svg_category":"muscular|nutricao|hormonal|comportamento","svg_element":"elemento válido","cards":[{"accent":"cyan|gold","title":"título","description":"explicação completa em 35 a 55 palavras"}]},{"slide_number":3,"type":"content","variation":"B","header":"título","category_tag":"tag","svg_category":"categoria","svg_element":"elemento válido","paragraphs":[{"title":"título curto","text":"explicação completa em 40 a 65 palavras","reference":"fonte presente na pesquisa"}]},{"slide_number":4,"type":"content","variation":"C","header":"título","category_tag":"tag","svg_category":"categoria","svg_element":"elemento válido","blocks":[{"title":"título","description":"aplicação ou contraponto em 35 a 55 palavras","reference":"fonte presente na pesquisa"}]},{"slide_number":5,"type":"cta","impact_phrase":"síntese memorável em até 12 palavras","cta_text":"CTA para salvar, compartilhar ou diagnóstico gratuito"}],"caption":"legenda completa entre 500 e 800 caracteres, texto limpo, com desenvolvimento, contraponto e CTA","sources":["somente URLs presentes na pesquisa"]}`,
  reciclar_10: `{"formatos":{"stories_enquete":{"formato":"stories_enquete","titulo":"título curto","itens":["3 frames, cada um com texto do frame e a enquete"]},"reels_falado":{"formato":"reels_falado","titulo":"hook","itens":["roteiro falado de 30s em blocos"]},"thread_texto":{"formato":"thread_texto","texto":"versão em texto corrido, até 300 caracteres"},"imagem_citacao":{"formato":"imagem_citacao","titulo":"frase de impacto","texto":"orientação de design"},"infografico":{"formato":"infografico","titulo":"título","itens":["3 a 5 pontos resumidos"]},"respostas_comentarios":{"formato":"respostas_comentarios","itens":["5 respostas prontas"]},"story_dado":{"formato":"story_dado","titulo":"dado do tema","texto":"story único"},"desafio":{"formato":"desafio","titulo":"faça isso por X dias","itens":["regras do desafio"]},"repost_30dias":{"formato":"repost_30dias","titulo":"novo hook","texto":"versão otimizada pra repostar em 30 dias"}}}`,
};
...
- Toda fonte citada tem de estar copiada literalmente da pesquisa recebida e ser rastreável (link, DOI, PMID ou autor + ano). É proibido escrever fonte genérica ("estudos mostram", "literatura", "consenso"), inventar autor, revista, ano ou número de amostra, e completar uma citação incompleta. Se um dado da pesquisa não vier com fonte rastreável, deixe o campo de fonte como string vazia e não apresente o dado como resultado de estudo.
...
- Título de slide 25 a 50 caracteres; corpo SEMPRE preenchido com 120 a 200 caracteres (2 a 3 frases completas) — slide com corpo curto ou vazio é erro; "destaque" é um número ou palavra curta (máx 18 caracteres) ou string vazia.
...
- Nenhum slide pode ficar visualmente vazio: todo slide de conteúdo traz corpo completo e, quando houver dado real da tela, 2 a 3 itens em "dados". Se não houver dado real, aprofunde o corpo com mecanismo, erro comum e aplicação prática.

...
type Mode = "caption" | "reel" | "calendar" | "hashtags" | "stories" | "audit" | "bio_audit" | "feed_audit" | "content_full"
  ...
  | "studio_subtitles" | "studio_versions" | "studio_vision" | "video_content" | "video_overlay"
...
const SCHEMAS: Record<Mode, string> = {
  ...
  video_overlay: `{"exercicio":"Nome do exercício","padrao":"Squat|Push|Pull|Hinge|Carry|Rotation","musculos_primarios":["max 3"],"musculos_secundarios":["max 4"],"zonas_ativas":{"peitoral_dir":false,"peitoral_esq":false,"deltoide_ant":false,"deltoide_lat":false,"deltoide_post":false,"biceps":false,"triceps":false,"antebraco":false,"trapezio":false,"dorsais":false,"lombar":false,"abdomen":false,"obliquos":false,"gluteos":false,"quadriceps":false,"isquiotibiais":false,"panturrilha":false,"adutor":false},"intensidade_ativacao":{"peitoral_dir":0,"peitoral_esq":0,"deltoide_ant":0,"deltoide_lat":0,"deltoide_post":0,"biceps":0,"triceps":0,"antebraco":0,"trapezio":0,"dorsais":0,"lombar":0,"abdomen":0,"obliquos":0,"gluteos":0,"quadriceps":0,"isquiotibiais":0,"panturrilha":0,"adutor":0},"cue_principal":"A dica técnica #1 em poucas palavras","cues_secundarios":["dica 2","dica 3"],"angulacoes":["Joelho 90°","Quadril neutro"],"fase_concentrica":"Descrição curta da fase concêntrica","fase_excentrica":"Descrição curta da fase excêntrica","alerta":"Principal risco sem avaliação prévia — 1 frase","frase_impacto":"Frase poderosa e compartilhável sobre este exercício"}`,
